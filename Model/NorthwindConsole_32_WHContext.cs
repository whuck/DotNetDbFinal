...
{
    public partial class NorthwindConsole_32_WHContext : DbContext
    {
        public NorthwindConsole_32_WHContext()
        {
        }

        public NorthwindConsole_32_WHContext(DbContextOptions<NorthwindConsole_32_WHContext> options)
            : base(options)
        {
        }
